...
INSERT OR IGNORE INTO DomainValues (Domain, Value, Name, Description, SortIndex)
    VALUES
        ...
        ('ZG_TechnologyCostAgeDomain', 'ZG_TECHNOLOGY_COST_PLUS_35', 'LOC_ZG_PCT_PLUS_35', 'LOC_ZG_TECHNOLOGY_COST_AGE_DESC_PLUS_35', 40),
        ('ZG_TechnologyCostAgeDomain', 'ZG_TECHNOLOGY_COST_PLUS_45', 'LOC_ZG_PCT_PLUS_45', 'LOC_ZG_TECHNOLOGY_COST_AGE_DESC_PLUS_45', 50),
        ('ZG_TechnologyCostAgeDomain', 'ZG_TECHNOLOGY_COST_PLUS_50', 'LOC_ZG_PCT_PLUS_50', 'LOC_ZG_TECHNOLOGY_COST_AGE_DESC_PLUS_50', 60),
        ('ZG_TechnologyCostAgeDomain', 'ZG_TECHNOLOGY_COST_PLUS_60', 'LOC_ZG_PCT_PLUS_60', 'LOC_ZG_TECHNOLOGY_COST_AGE_DESC_PLUS_60', 70),
        ('ZG_TechnologyCostAgeDomain', 'ZG_TECHNOLOGY_COST_PLUS_75', 'LOC_ZG_PCT_PLUS_75', 'LOC_ZG_TECHNOLOGY_COST_AGE_DESC_PLUS_75', 80),
        ('ZG_TechnologyCostAgeDomain', 'ZG_TECHNOLOGY_COST_PLUS_85', 'LOC_ZG_PCT_PLUS_85', 'LOC_ZG_TECHNOLOGY_COST_AGE_DESC_PLUS_85', 90),
        ...
        ('ZG_CivicCostAgeDomain', 'ZG_CIVIC_COST_PLUS_35', 'LOC_ZG_PCT_PLUS_35', 'LOC_ZG_CIVIC_COST_AGE_DESC_PLUS_35', 40),
        ('ZG_CivicCostAgeDomain', 'ZG_CIVIC_COST_PLUS_45', 'LOC_ZG_PCT_PLUS_45', 'LOC_ZG_CIVIC_COST_AGE_DESC_PLUS_45', 50),
        ('ZG_CivicCostAgeDomain', 'ZG_CIVIC_COST_PLUS_50', 'LOC_ZG_PCT_PLUS_50', 'LOC_ZG_CIVIC_COST_AGE_DESC_PLUS_50', 60),
        ('ZG_CivicCostAgeDomain', 'ZG_CIVIC_COST_PLUS_60', 'LOC_ZG_PCT_PLUS_60', 'LOC_ZG_CIVIC_COST_AGE_DESC_PLUS_60', 70),
        ('ZG_CivicCostAgeDomain', 'ZG_CIVIC_COST_PLUS_75', 'LOC_ZG_PCT_PLUS_75', 'LOC_ZG_CIVIC_COST_AGE_DESC_PLUS_75', 80),
        ('ZG_CivicCostAgeDomain', 'ZG_CIVIC_COST_PLUS_85', 'LOC_ZG_PCT_PLUS_85', 'LOC_ZG_CIVIC_COST_AGE_DESC_PLUS_85', 90),
        ...
        ('ZG_VictoryProjectCostAgeDomain', 'ZG_VICTORY_PROJECT_COST_PLUS_20', 'LOC_ZG_PCT_PLUS_20', 'LOC_ZG_VICTORY_PROJECT_COST_AGE_DESC_PLUS_20', 30),
