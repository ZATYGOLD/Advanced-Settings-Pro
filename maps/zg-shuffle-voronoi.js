// Copy of {base-standard}maps/shuffle-voronoi.js; map feature generation is
...
import { VoronoiShuffle } from 'fs://game/base-standard/scripts/voronoi_maps/shuffle.js';
import { zgGenerateMapFeatures } from './zg-map-generation.js';

console.log("Generating using script shuffle-voronoi.ts");
...
async function generateMap() {
  ...
  const voronoiScope = new profileScope("Shuffle Voronoi Generation");
  ...
  const voronoiMap = new VoronoiShuffle();
