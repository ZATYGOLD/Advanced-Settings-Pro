// Copy of {base-standard}maps/continents.js with a tier-aware river model;
...
import { expandCoasts, addMountains, generateLakes, addHills, buildRainfallMap } from 'fs://game/base-standard/maps/elevation-terrain-generator.js';
...
import { g_OceanWaterColumns, g_PolarWaterRows, g_WaterPercent, g_Cutoff, g_NavigableRiverTerrain, g_LandmassFractal, g_FlatTerrain, g_OceanTerrain, g_FractalWeight, g_CenterWeight, g_StartSectorWeight, g_CoastTerrain } from 'fs://game/base-standard/maps/map-globals.js';
import { needHumanNearEquator, applyCoastalErosionAdjustingForStartSectors, createOrganicLandmasses, applyCoastalErosion, markLandmassRegionId, getHeightAdjustingForStartSector, getSector } from 'fs://game/base-standard/maps/map-utilities.js';
