...
import { g_PolarWaterRows, g_AvoidSeamOffset, g_IslandWidth, g_WaterPercent, g_Cutoff, g_OceanWaterColumns, g_NavigableRiverTerrain, g_LandmassFractal, g_FlatTerrain, g_OceanTerrain, g_FractalWeight, g_StartSectorWeight } from 'fs://game/base-standard/maps/map-globals.js';
import { needHumanNearEquator, createIslands, createOrganicLandmasses, markLandmassRegionId, getHeightAdjustingForStartSector } from 'fs://game/base-standard/maps/map-utilities.js';
